...
describe('getProps', () => {
    ...
    describe('When we get props for multiple elements with allowMultiple set to true',  () => {
        it('Returns an array of props', () => {
    ...
    describe('When we get props when no elements exist', () => {
        it('Throws an error',  () => {
